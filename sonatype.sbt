...
ThisBuild / homepage := Some(url("https://github.com/accur8/versions"))
ThisBuild / scmInfo := Some(ScmInfo(url("https://github.com/accur8/versions"), "scm:git@github.com:accur8/versions.git"))
